...
export const ExcelUtils = {
  ...
  writeWithTemplate: async (
    ...
    if (workBook) {
      ...
      if (!worksheet) {
        throw new Error("Cannot found worksheet!")
      }

      if (cellToWrites) {
        const cellRefForEachRow = handleCellRefData(data, cellToWrites)
 ...
 *        '*[A,B,C]'
 */
const handleCellRefData = (data: object[], cellToWrites: string) => {
